...
export function FikraFooter() {
  const currentYear = new Date().getFullYear();

  return (
    <footer style={{ background: "#07080F", position: "relative", overflow: "visible" }} className="px-4 pt-10 pb-8">
      {/* Card */}
      <div
        className="relative rounded-3xl max-w-[1200px] mx-auto px-6 md:px-12 py-12"
        style={{
          background: "#0C1523",
      ...
      >
        ...
        <div
          ...
          style={{ top: "-20px", left: "-20px", transform: "rotate(-15deg)" }}
        >
          {tape}
        </div>
        {/* Shard — bottom-right (mirror of left) */}
        <div
          className="hidden md:block absolute"
          style={{ top: "-20px", right: "-20px", transform: "rotate(15deg) scaleX(-1)" }}
        >
          {tape}
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-12">
          {/* Brand */}
          <div className="flex flex-col gap-3 lg:max-w-[220px]">
            <Link href="/" aria-label="Fikra Technology home">
              <span
                style={{
              ...
              >
                Fikra<span style={{ color: "#1E6FBF" }}>.</span>
              </span>
            </Link>
            <p
              style={{
            ...
            >
              Software that works. Partners who stay. Results that last.
            </p>
            <p
              style={{
            ...
            >
              Abu Dhabi, UAE · Alexandria, Egypt
            </p>
          </div>

          {/* Nav columns */}
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-16 flex-1">
            {/* Services */}
      ...
      {/* Bottom strip */}
      <div className="mt-4 px-2 md:px-4 max-w-[1200px] mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-8 items-start sm:items-center">
          ...
          >
            © {currentYear} Fikra Technology. All rights reserved.
          </p>
        </div>

        <div className="flex gap-4 items-center">
          <a
            href="https://linkedin.com/company/fikratechnology"
            target="_blank"
            rel="nofollow noopener"
            aria-label="Fikra Technology on LinkedIn"
            className="text-white/30 hover:text-white transition-colors duration-150 cursor-pointer"
          >
            <LinkedinIcon className="w-4 h-4" />
          </a>
          <a
            href="https://twitter.com/fikratech"
            target="_blank"
            rel="nofollow noopener"
            aria-label="Fikra Technology on X (Twitter)"
            className="text-white/30 hover:text-white transition-colors duration-150 cursor-pointer"
          >
